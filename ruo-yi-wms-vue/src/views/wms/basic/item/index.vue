        ...
        <el-card class="mt20">
          ...
          <el-form :model="skuForm" :rules="skuRules" ref="skuFormRef" :show-message="false">
            <el-table :data="skuForm.itemSkuList" border cell-class-name="my-cell">
              ...
              <el-table-column label="安全库存/最大库存" width="240">
                <template #default="scope">
                  <div class="flex-center">
                    <span class="mr5">安全库存</span>
                    <el-input-number :controls="false" :min="0" :precision="0" v-model="scope.row.safetyStock"/>
                  </div>
                  <div class="flex-center mt5">
                    <span class="mr5">最大库存</span>
                    <el-input-number :controls="false" :min="0" :precision="0" v-model="scope.row.maxStock"/>
                  </div>
                </template>
              </el-table-column>
