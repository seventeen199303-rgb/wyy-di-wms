  ...
  <div class="app-container">
    <el-card>
      <el-form :model="queryParams" ref="queryRef" label-width="90px" :inline="true">
        ...
        <el-form-item class="col4" label="库区" prop="zoneId">
          <el-select style="width: 100%" v-model="queryParams.zoneId" placeholder="请选择库区"
                     filterable clearable>
            <el-option v-for="item in zoneList" :key="item.id" :label="item.zoneName"
                       :value="item.id"/>
          </el-select>
        </el-form-item>
    ...
    <el-card class="mt20">
      ...
      <el-table :data="inventoryList" border :span-method="spanMethod"
        ...
        <el-table-column label="库区" prop="zoneName" width="130" />
