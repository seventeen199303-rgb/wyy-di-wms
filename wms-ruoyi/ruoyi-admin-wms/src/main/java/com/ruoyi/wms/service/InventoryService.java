...
public class InventoryService extends ServiceImpl<InventoryMapper, Inventory> {
    ...
    public void add(List<? extends BaseOrderDetailBo> details) {
        ...
        details.forEach(orderDetailsBo -> {
            ...
            wrapper.eq(orderDetailsBo.getZoneId() != null, Inventory::getZoneId, orderDetailsBo.getZoneId());
            wrapper.eq(orderDetailsBo.getLocationId() != null, Inventory::getLocationId, orderDetailsBo.getLocationId());
    ...
    public void subtract(List<? extends BaseOrderDetailBo> details) {
        ...
        details.forEach(shipmentOrderDetailBo -> {
            ...
            wrapper.eq(shipmentOrderDetailBo.getZoneId() != null, Inventory::getZoneId, shipmentOrderDetailBo.getZoneId());
            wrapper.eq(shipmentOrderDetailBo.getLocationId() != null, Inventory::getLocationId, shipmentOrderDetailBo.getLocationId());
            Inventory result = inventoryMapper.selectOne(wrapper);
            if(result==null){
